...
if (isset($_POST['modificar'])) {
	...
	$idMaquinaria = $maquinariaActual[0]->getId();
	$idUs = $maquinariaActual[0]->getIdUsuario();
	$equipo =  $_POST['equipo'];
	...
	$fotoMaquinaria = $maquinariaActual[0]->getRutaFoto();
	...
	$m = new Maquinaria($idMaquinaria, $idUs, $equipo, $numeroSerie, $fechaAdquisicion, $ubicacion, $tipoMantenimiento, $costeAdquisicion, $estado, $observaciones, $fotoMaquinaria);
		...
		<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--8-col-desktop mdl-cell--2-offset-desktop">
			<div class="full-width panel mdl-shadow--2dp">
				...
				<div class="full-width panel-content">
					<form action="modificarMaquinaria.php?id=<?php echo $idMaquinaria; ?>" method="post" enctype="multipart/form-data">
